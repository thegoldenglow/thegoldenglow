...
const HomeLayout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen text-white relative overflow-y-auto pb-28"> {/* Increased bottom padding to prevent footer overlap on content */}
      ...
      */}
      ...
      <header className="sticky top-0 z-10 backdrop-filter backdrop-blur-md border-b border-royalGold/30">
        <div className="max-w-4xl mx-auto px-4 py-3 flex justify-between items-center" data-component-name="HomeLayout">
          ...
          <div className="flex items-center">
            ...
            <div className="flex items-center mr-2 p-2 rounded-lg" style={{
      ...
      <footer className="fixed bottom-0 left-0 right-0 z-10 py-3 px-4" data-component-name="HomeLayout" style={{
