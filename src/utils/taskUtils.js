...
import { TaskType, RewardType } from './taskConstants';
...
export const getTaskRequirement = (task) => {
  // Handle Content Engagement tasks
  if (task.taskCategory === 'Content Engagement') {
    const viewingTime = task.requiredViewingTime || 30;
    return `View embedded post for ${viewingTime} seconds`;
  }
