...
A complete webhook-based implementation using Netlify Functions is provided.
...
2. Check Webhook Status via /telegram-setup.html
...
```
Reset it using /telegram-setup.html if needed.

### Bot Commands Not Updating
1. Visit /telegram-setup.html
2. Delete Webhook
3. Set Bot Webhook again
4. Wait 1-2 minutes for Telegram to update

### Membership Check Failing
- Make the bot an administrator in the required channel
- Or set TELEGRAM_SKIP_MEMBERSHIP_CHECK=true to disable verification

---

## 🚀 Deployment Checklist

- Add TELEGRAM_BOT_TOKEN to Netlify env vars
- Deploy site to Netlify
- Visit /telegram-setup.html
- Click "Set Bot Webhook"
- Verify webhook is set correctly
- Test /start
- Verify /help, /referral, /stats
